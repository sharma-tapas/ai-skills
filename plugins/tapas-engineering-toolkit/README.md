...
This plugin is part of the `tapas-engineering-marketplace`. To install:
...
```bash
claude plugin add /path/to/ai-skills/plugins/tapas-engineering-toolkit
```
